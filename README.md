# Southampton Coffee Map

A web map of coffee shops in Southampton (UK) with support for location filtering.\
...
`NEXT_PRIVATE_CMS_HOST_KEY` \
[ Required ] A valid CMS key with read access to the relevant collection(s).
